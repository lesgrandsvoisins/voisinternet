---
title: Thoughts about Creative Commons CC-BY-NC-SA (EN)
...
1. The most basic thing to do is to attribute the work to  (c) Robert Baldrige with preferably a link to the @RobertBaldrigeOfficial Instagram account.
2. The second basic thing is to allow Robert to see the use of his work, to inform him of it. Robert also avails himself to the creative process around the publication of his work, but is amenable to publishers.
...
One of the speakers at the [Thanks for Nothing Colloque on Arts et Engagement 2023](https://thanksfornothing.fr/project/colloque-mois-art-engagement-2023/), Camille Etienne, would dance in the artic in her web production [Pourquoi on se bat](https://www.tv5mondeplus.com/fr/details/vod/107156818_74079A). That speaker reminded me of Robert's shoot. The cliché isn't on Google, shoot. I didn't think it would be. Robert is sensitive because, and this is understandable, the viewing of Robert's work starts in the moment the shutter stutters. The musicians knew this, but where are they?
...
In order to achieve some possibility at posterity, I need the works. Most of them are on a hard drive, somewhere.  Now, I've been a photographer too, and a geek, the computer kind of geek (and other kinds of geek too, but that is for another story). At Les Grands Voisins, we have launched a social computer room "Creative Digital" as part of [our digital activities](https://blog.lesgrandsvoisins.com/tag/resdigita/) (also called ResDigita). One reason for this is to provide digital locker rooms for the computerless or the computer-vulnerable. Thus we have the talent to be custodians.

In Robert's case, we are talking about work that might be bigger than Robert, and I also would like for [our artistic activities](https://blog.lesgrandsvoisins.com/tag/arts/) (also called Les Arts Voisins) to be able to curate something worthwhile both for Robert and for the world. This brings me to the heart of why I am writing this article, an article that is becoming a little longer than article I usually write.

How do you value "a Baldridge?"

Robert may come to an agreement with you about how you may use his work. The base rules are detailed above: attribute the work to Robert, preferably with a link to the [RobertBaldridgeOfficial Instagram](https://www.instagram.com/robertbaldridgeofficial/) account, and involve Robert in the publication process. But that doesn't help much, or might not be precise enough. Let's take this one step further.

Engage an email exchange with Robert via RobertBaldridge at hotmail.com (I really got to help Robert use a domain name that Robert controls) asking for permission, preferable with some kind of compensation, preferably money, but it could be troc. If you agree to the troc, most likely, and by default, Robert will grant you an [CC-BY-NC-SA](https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode) license after you have agreed to the two terms above (I repeat):

1. Attribution (c) [Robert Baldridge](https://www.instagram.com/robertbaldridgeofficial/) (integrated in the BY part of the CC-BY-NC-SA)
2. Initial publication with Robert's involvement on some level resulting in Robert's traditional "that's fine"

You should also compensate Robert somehow: cash, check or wiretransfer in monetary terms for the time being ; or maybe some kind of barter. Other, preferably non-exclusive commercial uses are also available. I guess, if Robert grants CC-BY-NC-SA (with compensation and involvement in initial publication), one could credit with "(c) [Robert Baldridge](https://www.instagram.com/robertbaldridgeofficial/) 2023 [CC-BY-NC-SA](https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode)".

This legal framework for setting edges around Robert's body of work is my proposition. I think Robert can use it. There is one sticking point in the CC-BY-NC-SA license that Robert told me he wants to use. I am not sure that Robert understands fully that after the first license is accorded, all further uses distributed by the initial licensee only need the [CC-BY-NC-SA](https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode) conditions. Therefor, maybe it would be better that Robert be credited without necessarily mentioning the [CC-BY-NC-SA](https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode) in the credit explicitly... I think there may be a creative digital-geek thing that is simpler than you would imagine here. I have an idea! For now, the "(c) [Robert Baldridge](https://www.instagram.com/robertbaldridgeofficial/) 2023" accreditation with an implicit, non-publicized [CC-BY-NC-SA](https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode) is probably the better way to go about Robert's past work. Of course, if anyone asks, [CC-BY-NC-SA](https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode) grants the licensee the distribution rights by the same terms even though the initial licensee probably had to agree to extra conditions to obtain the initial [CC-BY-NC-SA](https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode) (consideration / compensation, collaboration / creative process even though Robert is Easy ;) ).
